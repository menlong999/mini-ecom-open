export const OrderStatus = {
  ALL: 'ALL', // 全部
  PENDING_PAYMENT: 'PENDING_PAYMENT', // 5 待支付
  PENDING_DELIVERY: 'PENDING_DELIVERY', // 10 待发货
  PENDING_RECEIPT: 'PENDING_RECEIPT', // 40 待收货
  COMPLETE: 'COMPLETE', // 50 已完成/待评价
  PAYMENT_TIMEOUT: 'PAYMENT_TIMEOUT', // 80 已取消，支付超时
  CANCELED_NOT_PAYMENT: 'CANCELED_NOT_PAYMENT', // 80 已取消，未支付主动取消
  CANCELED_PAYMENT: 'CANCELED_PAYMENT', // 80 已取消，已支付主动取消
  CANCELED_REJECTION: 'CANCELED_REJECTION', // 80 已取消，拒收
};
...
export const CancelResonTypes = {
  USER_CANCEL: 10, // 用户取消
  OUT_OF_STOCK: 11, // 商品缺货
  PRICE_HIGH: 12, // 价格太高
  PAYMENT_TIMEOUT: 13, // 支付超时
  OTHER: 14, // 其他原因
};
