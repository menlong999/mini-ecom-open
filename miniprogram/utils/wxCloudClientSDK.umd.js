(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
      factory((global.wxCloudClientSDK = {})));
  ...
  var callDataSource = function (_a) {
    var dataSourceName = _a.dataSourceName,
      ...
      params = _a.params,
      realMethodName = _a.realMethodName,
      callFunction = _a.callFunction,
      _b = _a.envType,
      envType = _b === void 0 ? 'prod' : _b,
      mode = _a.mode;
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          ...
          case 2:
            response = _e.sent();
            requestId =
              ((_c = response === null || response === void 0 ? void 0 : response.result) ===
                null || _c === void 0
                ? void 0
                : _c.requestId) ||
              (response === null || response === void 0 ? void 0 : response.requestId) ||
              (response === null || response === void 0 ? void 0 : response.requestID);
            if (response === null || response === void 0 ? void 0 : response.result.code) {
              throw new WxCloudSDKError(
                '\u3010\u9519\u8BEF\u3011'
                  .concat(
                    response === null || response === void 0 ? void 0 : response.result.message,
                    '\n\u3010\u64CD\u4F5C\u3011\u8C03\u7528 models.'
                  )
                  .concat(dataSourceName ? ''.concat(dataSourceName, '.') : '')
                  .concat(realMethodName, '\n\u3010\u9519\u8BEF\u7801\u3011')
                  .concat(
                    response === null || response === void 0 ? void 0 : response.result.code,
                    '\n\u3010\u8BF7\u6C42ID\u3011'
                  )
                  .concat(requestId || 'N/A'),
                {
              ...
              result.data =
                ((_d = response === null || response === void 0 ? void 0 : response.result) ===
                  null || _d === void 0
                  ? void 0
                  : _d.data) || {};
  ...
  var HTTP_DATA_MODEL_METHODS = {
    get: __assign(__assign({}, createDefaultMethod('get')), {
      defaultParams: __assign({}, READ_DEFAULT_PARAMS),
    }),
    list: __assign(__assign({}, createDefaultMethod('list')), {
      defaultParams: __assign({}, READ_DEFAULT_PARAMS),
    }),
            ...
            return function (params) {
              ...
              return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                  switch (_c.label) {
                    case 0:
                      (getUrl = httpDataModelMethod_1.getUrl),
                        (method = httpDataModelMethod_1.method),
                        (_a = httpDataModelMethod_1.defaultParams),
                        (defaultParams = _a === void 0 ? {} : _a);
                    ...
                    case 2:
                      ...
                      if (methodName === 'get') {
                        ...
                        Object.assign(result, {
                          data:
                            (_b = result.data.record) !== null && _b !== void 0 ? _b : result.data,
                        });
                      }
                      return [2 /*return*/, result];
                    case 3:
                ...
                return __generator(this, function (_j) {
                  switch (_j.label) {
                    ...
                    case 2:
                      result = _j.sent();
                      if (
                        (_a = result === null || result === void 0 ? void 0 : result.Response) ===
                          null || _a === void 0
                          ? void 0
                          : _a.Error
                      ) {
                        ...
                        throw createWxCloudSDKError(
                          ...
                          (_e =
                            ...
                            ? void 0
                            : _e.Code,
                          (_f = result === null || result === void 0 ? void 0 : result.Response) ===
                            null || _f === void 0
                            ? void 0
                            : _f.RequestId
                        );
          ...
          return function (params) {
            return __awaiter(void 0, void 0, void 0, function () {
              ...
              return __generator(this, function (_b) {
                switch (_b.label) {
                  case 0:
                    effectiveParams = __assign(
                      __assign({}, operation.defaultParams || {}),
                      params || {}
                    );
                    return [
                      4 /*yield*/,
                  ...
                  case 1:
                    ...
                    result.data = dataKey
                      ? (_a = rawData === null || rawData === void 0 ? void 0 : rawData.data) ===
                          null || _a === void 0
                        ? void 0
                        : _a[dataKey]
  ...
  function initHTTPOverCallFunction(cloud, options) {
    ...
    try {
          ...
          return __generator(this, function (_c) {
            switch (_c.label) {
              ...
              case 1:
                res = _c.sent();
                result =
                  (_b = res === null || res === void 0 ? void 0 : res.result) === null ||
                  _b === void 0
                    ? void 0
                    : _b.body;
                return [2 /*return*/, result];
      ...
      var baseUrl =
        (options === null || options === void 0 ? void 0 : options.baseUrl) ||
        getDefaultGatewayBaseUrl(cloud).model;
      var sqlBaseUrl =
        (options === null || options === void 0 ? void 0 : options.sqlBaseUrl) ||
        getDefaultGatewayBaseUrl(cloud).sql;
  ...
  function getDefaultGatewayBaseUrl(cloud) {
    ...
    var env =
      (_b =
        (_a = cloud === null || cloud === void 0 ? void 0 : cloud.extend) === null || _a === void 0
          ? void 0
          : _a.AI) === null || _b === void 0
        ? void 0
        : _b.env;
    if (typeof env !== 'string' || !env.trim())
      env =
        (_c = cloud === null || cloud === void 0 ? void 0 : cloud.config) === null || _c === void 0
          ? void 0
          : _c.env;
    if (typeof env !== 'string' || !env.trim())
      env =
        (_d = cloud === null || cloud === void 0 ? void 0 : cloud.config) === null || _d === void 0
          ? void 0
          : _d.envName;
    if (typeof env !== 'string' || !env.trim()) {
...
// cache bust to force compiler re-analysis
