    ...
    chooseSpecValueId(specValueId, specId) {
      ...
      specList.forEach((item) => {
        if (item.specId === specId) {
          ...
          if (specSelectStatus) {
            const specsArray =
              subSpecValueItem && subSpecValueItem.hasStockObj
                ? subSpecValueItem.hasStockObj.specsArray
                : [];
            selectSpecObj[specId] = this.flatten(specsArray.concat(itemSelectArray));
          } else {
